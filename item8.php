          ...
          <div class="box">
            <a href="">
              <div class="product-content123">
                <div class="img-box1">
                  <img src="images/p8.png" style="width: 300px" class="img-box2" alt="">
                  <p>

                  </p>
                </div>
                <div class="text-box11">
                  <h6>Процессор AMD Ryzen 5 5600</h6>
                  <p>
                    Vermeer, AM4, 6 ядер, частота 4.4/3.5 ГГц, кэш 3 МБ + 32 МБ, техпроцесс 7 нм, TDP 65W
                  </p>
                  <h6>
                    Цена
                    <span>
                  ...
                  <div class="btn-box1">
                    <button onclick="addToCart('AMD RYZEN 5', 200)" class="btn1">Приобрести</button>
