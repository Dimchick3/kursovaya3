          ...
          <div class="box">
            <a href="">
              <div class="product-content123">
                <div class="img-box1">
                  <img src="images/p2.png" style="width: 400px" class="img-box2" alt="">
                  <p>

                  </p>
                </div>
                <div class="text-box11">
                  <h6>Игровой ноутбук Lenovo IdeaPad L340-15IRH Gaming 81LK00A2RK</h6>
                  <p>
                    15.6" 1920 x 1080, IPS, 60 Гц, Intel Core i5 9300H, 8 ГБ DDR4, SSD 512 ГБ, видеокарта NVIDIA GeForce GTX 1650 4 ГБ GDDR5, без ОС, цвет крышки черный, аккумулятор 45 Вт·ч
                  </p>
                  <h6>
                    Цена
                    <span>
                    ...
                    <div class="btn-box1">
                      <button onclick="addToCart('LENOVO L340-15IRH', 300)" class="btn1">Приобрести</button>
                    </div>
                </div>
              </div>
