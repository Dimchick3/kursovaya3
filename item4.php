          ...
          <div class="box">
            <a href="">
              <div class="product-content123">
                <div class="img-box1">
                  <img src="images/p4.png" style="width: 500px"  class="img-box2" alt="">
                  <p>

                  </p>
                </div>
                <div class="text-box11">
                  <h6>SSD Samsung 870 QVO 1TB MZ-77Q1T0BW</h6>
                  <p>
                  ...
                  <div class="btn-box1">
                    <button onclick="addToCart('SAMSUNG SSD 1TB', 45)" class="btn1">Приобрести</button>
