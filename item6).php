          ...
          <div class="box">
            <a href="">
              <div class="product-content123">
                <div class="img-box1">
                  <img src="images/p6.png" style="width: 300px"  class="img-box2" alt="">
                  <p>

                  </p>
                </div>
                <div class="text-box11">
                  <h6>Блок питания DeepCool PK550D</h6>
                  <p>
                    ATX 550 Вт, активная PFC, бронзовый сертификат, вентилятор 1x120 мм, 1x 12В 45.5А
                  </p>
                  <h6>
                    Цена
                    <span>
                  ...
                  <div class="btn-box1">
                    <button onclick="addToCart('DEEPCOOL PK550D', 70)" class="btn1">Приобрести</button>
