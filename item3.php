          ...
          <div class="box">
            <a >
              <div class="product-content123">
                <div class="img-box1">
                  <img src="images/p3.png"  class="img-box2" alt="">
                  <p>

                  </p>
                </div>
                <div class="text-box11">
                  <h6>Игровая мышь Lorgar Stricter 579</h6>
                  <p>
                  ...
                  <div class="btn-box1">
                    <button onclick="addToCart('LORGAR STRICTER 579', 110)" class="btn1">Приобрести</button>
