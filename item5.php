          ...
          <div class="box">
            <a href="">
              <div class="product-content123">
                <div class="img-box1">
                  <img src="images/p5.png"  class="img-box2" alt="">
                  <p>

                  </p>
                </div>
                <div class="text-box11">
                  <h6>Видеокарта Palit GeForce RTX 4070 Super Dual 12GB NED407S019K9-1043D</h6>
                  <p>
                  ...
                  <div class="btn-box1">
                    <button onclick="addToCart('GEFORCE RTX 4070', 895)" class="btn1">Приобрести</button>
