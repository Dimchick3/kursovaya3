          ...
          <div class="box">
            <a href="">
              <div class="product-content123">
                <div class="img-box1">
                  <img src="images/p7.png" style="width: 400px"  class="img-box2" alt="">
                  <p>

                  </p>
                </div>
                <div class="text-box11">
                  <h6>Материнская плата Gigabyte B760M Gaming X AX DDR4 (rev. 1.x)</h6>
                  <p>
                    mATX, сокет Intel LGA1700, чипсет Intel B760, память 4xDDR4 до 5333 МГц, слоты: 2xPCIe x16, 2xM.2, 802.11ax (Wi-Fi 6E)+Bluetooth 5.3
                  </p>
                  <h6>
                    Цена
                    <span>
                  ...
                  <div class="btn-box1">
                    <button onclick="addToCart('GIGABYTE B760M', 400)" class="btn1">Приобрести</button>
